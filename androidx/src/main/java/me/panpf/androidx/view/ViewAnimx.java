...
public class ViewAnimx {
     ...
     */
    public static void animationAlpha(@NotNull final View view, float fromAlpha, float toAlpha, long durationMillis,
     ...
     * @param listener       动画监听器
     */
    public static void animationAlpha(@NotNull final View view, float fromAlpha, float toAlpha, long durationMillis, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener  动画监听器
     */
    public static void animationAlpha(@NotNull final View view, float fromAlpha, float toAlpha, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param toAlpha   结束透明度
     */
    public static void animationAlpha(@NotNull final View view, float fromAlpha, float toAlpha) {
     ...
     * @param listener       动画监听器
     */
    public static void animationTranslate(@NotNull final View view, float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,
     ...
     * @param listener       动画监听器
     */
    public static void shake(@NotNull final View view, float extent, float cycles, long durationMillis,
     ...
     * @param listener 动画监听器
     */
    public static void shake(@NotNull final View view, @Nullable final Animation.AnimationListener listener) {
     ...
     * 视图左右摇晃
     */
    public static void shake(@NotNull final View view) {
     ...
     * @param listener       动画监听器
     */
    public static void shock(@NotNull final View view, float extent, float cycles, long durationMillis,
                             boolean isBanClick, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener 动画监听器
     */
    public static void shock(@NotNull final View view, @Nullable final Animation.AnimationListener listener) {
     ...
     * 视图上下震动
     */
    public static void shock(@NotNull final View view) {
     ...
     * @param listener    动画监听器
     */
    public static void startAnimationFromRes(@NotNull final View view, int animationId, final boolean isBanClick,
     ...
     * @param listener    动画监听器
     */
    public static void startAnimationFromRes(@NotNull final View view, int animationId, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param animationId 动画资源 ID
     */
    public static void startAnimationFromRes(@NotNull final View view, int animationId) {
     ...
     * @param listener       动画监听器
     */
    public static void invisibleByAnimationAlpha(@NotNull final View view, long durationMillis,
                                                 final boolean isBanClick, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener       动画监听器
     */
    public static void invisibleByAnimationAlpha(@NotNull final View view, long durationMillis, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener 动画监听器
     */
    public static void invisibleByAnimationAlpha(@NotNull final View view, @Nullable final Animation.AnimationListener listener) {
     ...
     * 使用透明度渐变动画隐藏 View，结束时 visibility 设为 INVISIBLE
     */
    public static void invisibleByAnimationAlpha(@NotNull final View view) {
     ...
     * @param listener       动画监听器
     */
    public static void goneByAnimationAlpha(@NotNull final View view, long durationMillis,
                                            final boolean isBanClick, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener       动画监听器
     */
    public static void goneByAnimationAlpha(@NotNull final View view, long durationMillis, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener 动画监听器
     */
    public static void goneByAnimationAlpha(@NotNull final View view, @Nullable final Animation.AnimationListener listener) {
     ...
     * 使用透明度渐变动画隐藏 View，结束时 visibility 设为 View.GONE
     */
    public static void goneByAnimationAlpha(@NotNull final View view) {
     ...
     * @param listener       动画监听器
     */
    public static void visibleByAnimationAlpha(@NotNull final View view, long durationMillis,
                                               final boolean isBanClick, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener       动画监听器
     */
    public static void visibleByAnimationAlpha(@NotNull final View view, long durationMillis, @Nullable final Animation.AnimationListener listener) {
     ...
     * @param listener 动画监听器
     */
    public static void visibleByAnimationAlpha(@NotNull final View view, @Nullable final Animation.AnimationListener listener) {
     ...
     * 使用透明度渐变动画显示 View
     */
    public static void visibleByAnimationAlpha(@NotNull final View view) {
