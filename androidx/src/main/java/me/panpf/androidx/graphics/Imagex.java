...
public class Imagex {
     ...
     */
    @Nullable
    public static String getMimeType(@Nullable Resources resources, @Nullable TypedValue value, @Nullable InputStream is, @Nullable Rect pad) {
        if (resources == null) return null;
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
     ...
     */
    @Nullable
    public static String getMimeSubType(@Nullable Resources resources, @Nullable TypedValue value, @Nullable InputStream is, @Nullable Rect pad) {
