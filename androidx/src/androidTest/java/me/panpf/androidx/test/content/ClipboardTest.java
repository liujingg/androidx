...
import me.panpf.androidx.test.widget.ToastTestActivity;
...
public class ClipboardTest {
    ...
    public void testIntent() {
        ...
        Intent intent = new Intent(context, ToastTestActivity.class);
    ...
    public void testMultiType() {
        ...
        ClipIntent intent = new ClipIntent(new Intent(context, ToastTestActivity.class));
