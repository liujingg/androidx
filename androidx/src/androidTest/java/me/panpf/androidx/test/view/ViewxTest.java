...
public class ViewxTest {
    ...
    @Test
    public void testSetLongClickToastHint() {
        ...
        Androidx.runInUI(new Runnable() {
            @Override
            public void run() {
                Viewx.setLongClickToastHint(view, "点我干嘛");
            }
        });
        try {
            Thread.sleep(100);
    ...
    @Test
    public void testSetLongClickToastHintRes() {
        final View view = activityRule.getActivity().getView();
        ...
        Androidx.runInUI(new Runnable() {
            @Override
            public void run() {
                Viewx.setLongClickToastHint(view, R.string.toast_test);
            }
        });
        try {
            Thread.sleep(100);
    ...
    public void testSetLayoutSize() throws InterruptedException {
        ...
        final View newView1 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        final View newView2 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
        ...
        final View newView3 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
        ...
        final View newView4 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
                return new View(activity);
    ...
    public void testInflateLayout() throws InterruptedException {
        ...
        View childView1 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        View childView2 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
        ...
        View childView3 = Androidx.waitRunInUIResult(new ResultRunnable<View>() {
            @NonNull
            @Override
            public View run() {
