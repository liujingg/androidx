 ...
 */
@ColorInt
fun Int.colorArgbEvaluate(@ColorInt endValue: Int, @FloatRange(from = 0.0, to = 1.0) fraction: Float): Int {
    return ArgbEvaluator().evaluate(fraction, this, endValue) as Int
}
